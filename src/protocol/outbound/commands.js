import {COMMAND_DEFAULT_FORMATS, COMMAND_FIELDS, encoder} from "../../constants.js";
import {concatBytes, toUint8Array} from "../codec/binary.js";
import {cloneDragValue, encodeMapHeader, encodeStringBytes, encodeValue} from "../codec/msgpack.js";
...
function sha256(bytes) {
    ...
    for (let offset = 0; offset < padded.length; offset += 64) {
        ...
        let a = state[0], b = state[1], c = state[2], d = state[3], e = state[4], f = state[5], g = state[6],
            h = state[7];
